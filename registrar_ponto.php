...
// Verificar se o ponto pode ser batido novamente
if (isset($_SESSION['last_time'])) {
    $last_time = strtotime($_SESSION['last_time']);
    $current_time = time();

  // Verificar se passou pelo menos uma hora desde o último registro
if ($current_time - $last_time < 3600) { // 3600 segundos = 1 hora
    $_SESSION['msg'] = "<p style='color: red;'>Você só pode bater o ponto novamente após 1 hora de descanso.</p>";
...
// Se passou uma hora ou é a primeira batida, atualizar o horário do último registro
